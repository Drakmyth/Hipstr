...
{
	public sealed partial class NewMessagesView : Page//, INotifyPropertyChanged
	{
//		public event PropertyChangedEventHandler PropertyChanged;

		public NewMessagesViewModel ViewModel => (NewMessagesViewModel)DataContext;
